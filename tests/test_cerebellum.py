...
def test_cerebellum_reference_region_with_vermis():
    ...
    result = cerebellum_reference_region(
        cerebellum_img, brain_img, erode_cerebellum_by_voxels=1, dilate_vermis_by_voxels=2, dilate_cortex_by_voxels=2
    )
...
def test_cerebellum_reference_region_affine_preservation():
    ...
    custom_affine = np.array([[2, 0, 0, -10], [0, 2, 0, -10], [0, 0, 2, -10], [0, 0, 0, 1]])
