...
def cerebellum_reference_region(
    ...
    cerebellum_refregion = cerebellum.cerebellum_reference_region(
        cerebellum_data, brain_data
    )
    # save output
    nib.save(
        nib.Nifti1Image(
            cerebellum_refregion, nib.load(cerebellum_segmentation_file).affine
        ),
