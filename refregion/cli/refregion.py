...
def main():
    ...
    parser.add_argument(
        "--ref_indices", "-r", type=Path, required=True, help="Indices to include in the reference region"
    )
    parser.add_argument(
        "--erode", "-e", type=int, required=True, help="Number of voxels to erode the reference region by"
    )
    parser.add_argument(
        "--exclude_indices", "-x", type=Path, required=True, help="Indices to exclude from the reference region"
    )
    parser.add_argument(
        "--dialate",
        "-d",
