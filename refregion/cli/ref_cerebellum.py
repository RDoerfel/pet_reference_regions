...
def main():
    parser = argparse.ArgumentParser(description="Create a reference region for cerebellum")
    ...
    cerebellum_reference_region(args.cerebellum_segmentation_file, args.brain_segmentation, args.output_reference_region)
